...
export default function BobBookingsR3Client() {
  ...
  const facts = { ...continuationOf(state), checkinWindow: providerCheckinWindow(state, published) };
