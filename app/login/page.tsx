      ...
      {!mustLogoutForIssuer && !mustLogoutForUser && (
        <>
          ...
          <p className="mb-4 text-sm text-slate-600">
            Sign in with an app account. Demo user A and demo user B each lock
            the customer screens to one person, so you can open the flow in
            separate browsers or on different computers.
          </p>
          <DemoLoginButtons
