...
Unreferenced repair candidate **`4dd5cdc8d507991464cad093b4f6492cfa87cb6f`**, parent/base `8aff17268adbad8e52b4b077c85bbe50034d6c13`, exactly one commit ahead, remains **CANDIDATE/LOCAL-SYNTHETIC only** and has **FAILED independent Security retest**. Builder-side regressions covered listing-HCS failure, burn-after-transfer, HCS-after-transfer+burn, unknown-transfer-receipt and immediate concurrent retry, but #16 comment `5638843971` reproduced the lease-expiry stale-writer defect: later durable operation transitions are not fenced against the current lease/generation/revision, so an expired worker can overwrite a successor's newer receipts/state after lease rollover. The independent synthetic reproducer showed later burn/audit completion erased back to pending/running state. This establishes stale-progress clobbering, not a proven second refund/burn. SEC-WORLD-006 therefore remains OPEN and the target remains HOLD. A successor must fence every durable transition with lease/generation/revision or equivalent monotonic CAS/serialized-writer semantics and then survive the stale-writer rollover plus the original listing-HCS / burn-after-transfer / HCS-after-transfer+burn / unknown-receipt / concurrent-or-changed-scope resume matrix.
