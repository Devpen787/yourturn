...
An exact repair candidate now exists: unreferenced `4dd5cdc8d507991464cad093b4f6492cfa87cb6f`, parent/base `8aff17268adbad8e52b4b077c85bbe50034d6c13`, exactly one commit ahead. Builder-side synthetic tests report coverage for listing-HCS failure, burn-after-transfer, HCS-after-transfer+burn, unknown transfer receipt and concurrent retry. This is **CANDIDATE/LOCAL-SYNTHETIC only**: the SHA is not the branch head, has no GitHub CI/status or preview, and is not adopted/green/LIVE. Independent exact-source fault-injection retest is requested in #16 comment `5638192319`. The credential-bearing target remains HOLD and SEC-WORLD-006 remains OPEN until that review closes it. The unpublished proof-response hardening candidate is **LOCAL/FIXTURE** only and is a separate non-qualifying change.
...
- **Evidence pack: RED.** Hedera's canonical 45-USDC transaction-boundary proof is filled. The pack remains RED because World `4dd5cdc8...` still needs independent SEC-WORLD-006 closure/adoption, World LIVE/SIGNED-ROUTE/canonical-mandate bridge is missing, Ledger v2 `369ea0d1...` still needs exact-source/runtime/loopback clearance plus LIVE/DEVICE evidence, sponsor-backed fixture replacement and the final integrated adversarial E2E are still missing.
