...
Current Ledger boundary: `feature/ethonline-ledger@a1126a0e7d2e5bb679914b0409209799520f8646`, owner Continuity `34554710275` SUCCESS. SEC-LEDGER-005 remains independently CLOSED at CI/CONFIGURED. SEC-LEDGER-006 is now independently **CLOSED at CI/CONFIGURED** by attacker `feature/ethonline-security-ledger-006-retest@7e03f28ad0182ff1aec112a8a05ddd5a2bfcf914`, run `34555366707`, job `103126811462` — SUCCESS. The independent retest proves fresh authority loads only through current live validation; a later serialized mutation making the captured version stale is rejected even while the raw active record remains physically present; mutation during validation, odd/in-flight version, missing authority/live context, and stale holder/status/provider-policy/listing all fail closed; one-shot replay remains consumed. This closes the software/security lifecycle blocker but creates **no LIVE/DEVICE claim**. Physical identical-mandate DMK approve plus reject/cancel remains RED until safely captured, and final integration must preserve the guarded boundary.
...
PR #43 browser-Origin cleanup is now at `ccb07e45888a3c15ee691a5db7465029d76f4c7f`, owner Continuity `34553728277` SUCCESS. It narrowly treats `localhost` and `127.0.0.1` as equivalent loopback aliases only for matching scheme and effective port while preserving explicit loopback transport binding and wrong-scheme/port/non-loopback rejection. Because guard semantics changed, a bounded independent Security regression retest remains pending. This does not retroactively negate the successful Sandbox proof. Base World head `8aff17268adbad8e52b4b077c85bbe50034d6c13`, Continuity `34554016785` SUCCESS, provides the non-secret signed-route preflight; the registered-agent recovery route remains `CI/READY, NOT LIVE/SIGNED-ROUTE` and RED for real execution.
...
- World PR #43 cleanup: owner-green at `ccb07e45888a3c15ee691a5db7465029d76f4c7f`, bounded independent guard-regression retest pending; this does not reopen the completed Sandbox proof.
